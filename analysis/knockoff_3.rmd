...
### FDR and Power at low sparsity: $25\%$ true signal
...
ggplot(data = melt(as.data.frame(tdn.list[[1]] / k.vec[1])),
        aes(x = variable, y = value, col = variable)) +
  geom_violin(trim = TRUE) +
  stat_summary(fun.data = "mean_sdp", geom = "pointrange") +
  scale_color_manual(values = method.col) +
...
### FDR and Power at high sparsity: $5\%$ true signal
...
ggplot(data = melt(as.data.frame(tdn.list[[5]] / k.vec[5])),
        aes(x = variable, y = value, col = variable)) +
  geom_violin(trim = TRUE) +
  stat_summary(fun.data = "mean_sdp", geom = "pointrange") +
  scale_color_manual(values = method.col) +
