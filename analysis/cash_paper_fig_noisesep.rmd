...
FDP.sqrt.q.all.sep.plot <- ggplot(data = FDP.q.ggdata.0.9, aes(x = Method, y = FDP, fill = Method, color = Method)) +
  ...
  stat_summary(fun.y = mean.sq, geom = "point", size = 3, aes(shape = "mean.point"), position = position_dodge(width = 0.9), show.legend = FALSE) +
  ...
  scale_shape_manual(name = "mean.point", values = 13) +
