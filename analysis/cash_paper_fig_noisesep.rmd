...
FDP_noise_new.save <- gridExtra::arrangeGrob(
  z.sep.plot +
    ...
    theme(legend.title = element_blank(),
         ...
         plot.margin = grid::unit(c(5.5, 95.5, 10, 17.5), "points"),
         plot.title = element_text(size = 15),
         strip.text = element_text(size = 15),
         axis.title.x = element_blank(),
         axis.text.x = element_text(size = 12),
  ...
  FDP.sqrt.q.all.sep.plot +
    labs(x = 'FDP', title = bquote(paste('Distribution of FDP'))) +
    theme(plot.title = element_text(size = 15),
          axis.title.x = element_text(size = 15),
          strip.text = element_text(size = 15),
          plot.margin = grid::unit(c(5.5, 5.5, 5.5, 5.5), "points"),
  ...
  TDP.q.all.sep.plot +
    labs(x = 'TDP', title = bquote(paste('Distribution of TDP'))) +
    theme(plot.margin = grid::unit(c(5.5, 5.5, 5.5, 5.5), "points"),
          axis.title.x = element_text(size = 15),
          strip.text = element_text(size = 15),
          plot.title = element_text(size = 15),
  ...
  top = grid::textGrob(label = bquote(paste(
    'Nominal FDR = ', .(q), ' (', g[1], ' is Guassian; ', pi[0] == 0.9, ')')), gp = grid::gpar(fontsize = 17, fontface = 'bold'), hjust = 1)
)
