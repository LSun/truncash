---
title: Step-Down Multiple Comparison Procedures on Simulated Correlated Null to Control
  FWER
author: "Lei Sun"
date: '2016-11-29'
...
The two "step-down" multiple comparison procedures are referenced in [Prof. Emmanuel Candes](https://statweb.stanford.edu/~candes/)'s online lecture notes [[1]](https://github.com/LSun/truncash/blob/master/ref/Lecture6.pdf)[[2]](https://github.com/LSun/truncash/blob/master/ref/Lecture7.pdf). 
...
[Here](https://github.com/LSun/truncash/blob/master/output/p_null_liver_FWER_2.jpg) is another simulation, with only the random seed changed from $101$ to $1$ but nothing else.  This simulation only change the random seed from $101$ to $1$ but nothing else, and empirical FWER for both procedures looks much better.  I'm thinking it shows that VOOM does give $p$-values marginally uniform under the global null, and starting with most extreme $p$-values for correlated null data could control FWER.

The code to generate adjusted $p$-values are stored in [`StepDown.R`](https://github.com/LSun/truncash/blob/master/code/StepDown.R)
