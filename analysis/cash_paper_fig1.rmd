...
abline(v = c(0.005, pnorm(-sqrt(2 * log(1e4))) * 2, 0.05 / 1e4), lwd = 2, col = thresh.color, lty = 1 : 3)
...
abline(h = -log(c(
  ...
  0.05 / 1e4
)), lwd = 2, col = thresh.color, lty = 1 : 3)
...
legend("topright", inset = c(-0.8, 0.3),
       legend = c(
         "p-val = 0.005",
         'Univ Thresh',
         latex2exp::TeX('p-val = $0.05 / 10^4$')), lty = 1 : 3, lwd = 2, xpd = NA,
       col = thresh.color, ncol = 1, cex = 1.25, bty = "n")
