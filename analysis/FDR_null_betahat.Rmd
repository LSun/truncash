---
title: "FDR / $s$ value on Correlated Null: `betahat = betahat`, `sebetahat = betahat / zscore`"
author: "Lei Sun"
date: 2017-02-16
...
**$\hat\beta$ obtained from [the `limma::lmFit` step of the pipeline](nullpipeline.html), $\hat z$ obtained from [the last step of the pipeline](nullpipeline.html).**
