...
```{r}
FDP.q.g.plot.save <- gridExtra::arrangeGrob(density.g.plot, FDP.q.g.plot, heights = c(1, 2.5))

ggsave("../output/paper/FDP.q.g.pdf", FDP.q.g.plot.save, height = 6, width = 12)
```
...
```{r}
FDP.q.g.pi0.plot.save <- gridExtra::arrangeGrob(density.g.plot, FDP.q.g.pi0.plot, heights = c(1, 1.1))
