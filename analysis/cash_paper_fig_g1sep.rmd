...
density.g.ggdata$g <- factor(density.g.ggdata$g, levels = g1.names[c(1, 2, 3, 5, 6, 4)])
...
FDP.q.g.ggdata$g <- factor(FDP.q.g.ggdata$g, levels = g1.names[c(1, 2, 3, 5, 6, 4)])
```
...
ggsave("../output/paper/FDP.q.g.pdf", FDP.q.g.plot.save, height = 6, width = 10)
```
