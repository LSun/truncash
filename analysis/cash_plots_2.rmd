...
for (i in 1 : nsim) {
  ...
  colnames(pi0hat.list[[i]]) <- c("qvalue", "locfdr", "ASH", "CASH")
...
```{r}
saveRDS(pi0hat.list, "~/Desktop/temp/pi0hat.list.rds")
saveRDS(qvalue.list, "~/Desktop/temp/qvalue.list.rds")
saveRDS(svalue.list, "~/Desktop/temp/svalue.list.rds")
saveRDS(z.list, "~/Desktop/temp/z.list.rds")
saveRDS(sebetahat.list, "~/Desktop/temp/sebetahat.list.rds")
saveRDS(pi0.list, "~/Desktop/temp/pi0.list.rds")
saveRDS(beta.list, "~/Desktop/temp/beta.list.rds")
saveRDS(betahat.list, "~/Desktop/temp/betahat.list.rds")
```
