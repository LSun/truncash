...
FDP.q.g.plot <- ggplot(data = FDP.q.g.ggdata, aes(x = pi0, y = FDP)) +
  ...
  scale_color_manual(values = method.col.FDR) +
  scale_fill_manual(values = method.col.FDR) +
  facet_wrap(~g, nrow = 1) +
  geom_hline(yintercept = q, col = "black", linetype = "dashed", size = 1) +
...
FDP.q.g.pdf <- gridExtra::arrangeGrob(density.g.plot, FDP.q.g.plot, heights = c(1, 1.5))

ggsave("../output/fig/FDP.q.g.pdf", FDP.q.g.eps, height = 6, width = 9)
```
