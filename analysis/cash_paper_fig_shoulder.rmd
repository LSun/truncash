...
pdf("../output/paper/hist_z.pdf", width = 7.5, height = 5)
...
pdf("../output/paper/pval_z.pdf", width = 7.5, height = 5)
...
plot(sample(-log(p)), ylim = c(0, y.max), ylab = "-log(p-value)", main = expression('(f): Figure 1(c) z-scores'), cex.main = 2, cex.lab = 2, pch = 19)
abline(h = -log(c(
  0.005,
...
plot(-log(p.norm.1), ylim = c(0, y.max), ylab = "-log(p-value)", main = expression("(g): iid N(0,1) samples"), col = "blue", cex.main = 2, cex.lab = 2, pch = 19)
abline(h = -log(c(
  0.005,
  pnorm(-sqrt(2 * log(1e4))) * 2,
  0.05 / 1e4
...
plot(-log(p.norm.1.6), ylim = c(0, y.max), ylab = "-log(p-value)", main = expression(paste("(h): iid ", N(0, 1.6^2), " samples")), col = "green", cex.main = 2, cex.lab = 2, pch = 19)
abline(h = -log(c(
  0.005,
  pnorm(-sqrt(2 * log(1e4))) * 2,
  0.05 / 1e4
