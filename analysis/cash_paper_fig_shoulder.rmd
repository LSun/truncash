...
plot(ecdf(z), xlab = "z-score", ylab = "CDF", lwd = 2, main = expression("(a): Empirical CDF"), cex.main = 2, cex.lab = 2, xlim = c(-max(abs(z)), max(abs(z))))
...
legend("bottomright", c("Figure 1(c)\nz-scores", expression(N(0,1)), expression(N(0, 1.6^2))), lty = c(1, 2, 4), col = c("black", "blue", "green"), lwd = 3, cex = 1.5, bty = 'n', seg.len = 1.5, x.intersp = 0.5)
...
plot(ecdf(z), xlab = "z-score", ylab = "CDF", main = expression("(b): Left Tail"), lwd = 3, xlim = c(-5, -2.5), ylim = c(0, 0.05), cex.main = 2, cex.lab = 2, bty = "n")
box(col = "red")
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01)), col = "blue", lwd = 3, lty = 2)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01), 0, 1.6), col = "green", lwd = 3, lty = 4)

legend("topleft", inset=c(0, 0.1), c("Figure 1(c)\nz-scores", expression(N(0,1)), expression(N(0, 1.6^2))), lty = c(1, 2, 4), col = c("black", "blue", "green"), lwd = 3, cex = 1.5, bty = 'n', seg.len = 1.5, x.intersp = 0.5)
...
plot(ecdf(z), xlab = "z-score", ylab = "CDF", main = expression("(c): Right Tail"), lwd = 3, xlim = c(2.5, 5), ylim = c(0.95, 1), cex.main = 2, cex.lab = 2, bty = "n")
box(col = "red", lty = 5)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01)), col = "blue", lwd = 3, lty = 2)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01), 0, 1.6), col = "green", lwd = 3, lty = 4)
...
plot(sample(-log(p)), ylim = c(0, y.max), ylab = "-log(p-value)", main = expression('(d): Figure 1(c) z-scores'), cex.main = 2, cex.lab = 2, pch = 19)
abline(h = -log(c(
  0.005,
...
plot(-log(p.norm.1), ylim = c(0, y.max), ylab = "-log(p-value)", main = expression("(e): iid N(0,1) samples"), col = "blue", cex.main = 2, cex.lab = 2, pch = 19)
abline(h = -log(c(
  0.005,
  pnorm(-sqrt(2 * log(1e4))) * 2,
  0.05 / 1e4
...
legend("top",
       ...
       col = thresh.color[3 : 1], ncol = 1, bty = 'n', cex = 1.5)
...
plot(-log(p.norm.1.6), ylim = c(0, y.max), ylab = "-log(p-value)", main = expression(paste("(f): iid ", N(0, 1.6^2), " samples")), col = "green", cex.main = 2, cex.lab = 2, pch = 19)
abline(h = -log(c(
  0.005,
  pnorm(-sqrt(2 * log(1e4))) * 2,
  0.05 / 1e4
...
pdf("../output/paper/pval_z.pdf", width = 5, height = 5)

par(mar = c(4.5, 4.5, 2.5, 1))

hist(p, prob = TRUE, breaks = seq(0, 1, by = 0.01), xlab = "p-value", main = expression("(g): Histogram of p-values"), cex.main = 2, cex.lab = 2)
...
pdf("../output/paper/hist_z.pdf", width = 5, height = 5)

par(mar = c(4.5, 4.5, 2.5, 1))

hist(z, breaks = seq(-10, 10, by = 0.1), prob = TRUE, ylim = c(0, dnorm(0)), xlab = "z-score", xlim = range(c(abs(z), -abs(z))), main = expression("(h): Histogram of z-scores"), cex.main = 2, cex.lab = 2)
