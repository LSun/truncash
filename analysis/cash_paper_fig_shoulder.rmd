...
plot(ecdf(z), xlab = "z-score", ylab = "CDF", lwd = 2, main = expression("(a): Emp. CDF"), cex.main = 2, cex.lab = 2, xlim = c(-max(abs(z)), max(abs(z))))
...
legend("bottomright", c("Figure 1(c)\nz-scores", expression(N(0,1)), expression(N(0, 1.6^2))), lty = c(1, 2, 4), col = c("black", "blue", "green"), lwd = 3, cex = 1.75, bty = 'n', seg.len = 1.5, x.intersp = 0.5)
