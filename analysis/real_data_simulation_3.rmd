...
## Setting 1: $\pi_0 = 0.5$, $\sigma^2 = 1$

```{r gdash comparison 1, cache = TRUE}
pi0 = 0.5
sd = 1
set.seed(777)
...
```{r plotting 1, cache = TRUE, echo = FALSE}
comp.plot(gdash.comp, N, pi0)
```

## Setting 2: $\pi_0 = 0.9$, $\sigma^2 = 1$

```{r gdash comparison 2, cache = TRUE}
pi0 = 0.9
sd = 1
set.seed(777)
system.time(gdash.comp <- N_simulations(N, mat, nsamp, ngene, pi0, sd))
...
```{r plotting 2, cache = TRUE, echo = FALSE}
comp.plot(gdash.comp, N, pi0)
```

## Setting 3: $\pi_0 = 0.5$, $\sigma^2 = 2$

```{r gdash comparison 3, cache = TRUE}
pi0 = 0.5
sd = sqrt(2)
set.seed(777)
system.time(gdash.comp <- N_simulations(N, mat, nsamp, ngene, pi0, sd))
...
```{r plotting 3, cache = TRUE, echo = FALSE}
comp.plot(gdash.comp, N, pi0)
```

## Setting 4: $\pi_0 = 0.9$, $\sigma^2 = 2$

```{r gdash comparison 4, cache = TRUE}
pi0 = 0.9
sd = sqrt(2)
set.seed(777)
system.time(gdash.comp <- N_simulations(N, mat, nsamp, ngene, pi0, sd))
...
```{r plotting 4, cache = TRUE, echo = FALSE}
comp.plot(gdash.comp, N, pi0)
```

## Setting 5: $\pi_0 = 0.5$, $\sigma^2 = 3$

```{r gdash comparison 5, cache = TRUE}
pi0 = 0.5
sd = sqrt(3)
set.seed(777)
system.time(gdash.comp <- N_simulations(N, mat, nsamp, ngene, pi0, sd))
...
```{r plotting 5, cache = TRUE, echo = FALSE}
comp.plot(gdash.comp, N, pi0)
```

## Setting 6: $\pi_0 = 0.9$, $\sigma^2 = 3$

```{r gdash comparison 6, cache = TRUE}
pi0 = 0.9
sd = sqrt(3)
set.seed(777)
system.time(gdash.comp <- N_simulations(N, mat, nsamp, ngene, pi0, sd))
...
```{r plotting 6, cache = TRUE, echo = FALSE}
comp.plot(gdash.comp, N, pi0)
```
