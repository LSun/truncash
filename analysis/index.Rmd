...
* [Plots for the `CASH` paper: `ashr` with `uniform` vs `normal`](cash_plots_4.html)
* [Plots for the `CASH` paper: median FDP when $\pi_0 = 0.99$](cash_plots_5.html)
...
* [Decorrelation of posterior](decor_post.html)
* [The correlated $N(0, 1)$ histograms figure](cash_paper_fig1.html)
* [Deconvolutions with correlated or iid noise](cash_paper_fig_deconv.html)
* [The shoulder inflation figures](cash_paper_fig_shoulder.html)
* [The curves of standardized Gaussian derivatives](cash_paper_fig_gd.html)
* [The FDP in different $g_1$ figure](cash_paper_fig_g1sep.html)
...
* [The mouse heart data figure](cash_paper_fig_mouseheart.html)
* [The average CDF of correlated $z$-scores is close to $N(0,1)$](cash_paper_fig_avgecdf.html)
* [The CDF of $z$-scores with correlation kept or removed](cash_paper_fig_marginal.html)
