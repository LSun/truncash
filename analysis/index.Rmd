...
3. Scenarios that might be hostile to `knockoff`

* [`Knockoff` on small signals](knockoff_6.html)
* [`Knockoff` on design matrix correlation](knockoff_5.html)
* [A closer look at `Knockoff` on design matrix correlation](knockoff_7.html)
* [Quality of Knockoffs and Power](knockoff_8.html)
