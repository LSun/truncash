...
* [Normal means inference with heteroskedastic and correlated noise](ash_gd.html)
...
Essentially we hope to tell whether $n$ random samples are uniformly distributed, and the task seems more complicated than what it sounds.

* [Marginal distribution $z$ scores](marginal_z.html)

Take a look at the $z$ scores we've been experimenting with and check whether they truly are marginally $N\left(0, 1\right)$.  It's an enhanced version of the simulation on [occurrence of extreme observations](ExtremeOccurrence.html).
