...
Talked about using Gaussian derivatives to handle correlation at Matthew's group meeting.
...
* [Large-scale simulation with `CASH`, Part 1: Overall data sets](cash_sim_1.html)
* [Large-scale simulation with `CASH`, Part 2: Over-dispersed data sets](cash_sim_2.html)
* [Large-scale simulation with `CASH`, Part 3: Under-dispersed data sets](cash_sim_3.html)

Using the same framework of [Gaussian derivative likelihood](gd_lik_2.html), large-scale simulations are performed to illustrate the `CASH` model.
