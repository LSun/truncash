...
In Gaussian derivatives decomposition, weights $W_k$ contain substantial information. In order to produce a proper density, and in order to regularize the fitted density such that it plausibly describes an empiricall correlated null, we need to impose constraints on the weights.

* [True signal vs correlated null](alternative.html)
