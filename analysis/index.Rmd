...
The previous investigation is bogged down to a prototypical problem: the classic normal means problem, but with heteroskedastic and especially correlated noise.  Gaussian derivatives and `ASH` provide a way to tackle it.
