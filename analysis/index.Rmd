...
* [Histogram of correlated $z$ scores, Part 1](correlated_z.html)
* [Histogram of correlated $z$ scores, Part 2](correlated_z_2.html)

An implicit key question of this inquiry is: what's the behavior of $z$ scores under dependency?  We take a look at their histograms, first for randomly sampled data sets, and then for those most "hostile" to `ash`.
