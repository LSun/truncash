...
```{r zero average fdp, cache = TRUE, echo = FALSE}
...
lines(fdr.list, colMeans(matrix(unlist(fdp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fdr.list, colMeans(matrix(unlist(fdp.gdash), nrow = m, byrow = TRUE)), col = "blue")
lines(fdr.list, colMeans(matrix(unlist(fdp.qvalue), nrow = m, byrow = TRUE)), col = "yellow")
lines(fdr.list, colMeans(matrix(unlist(fdp.BH), nrow = m, byrow = TRUE)))
abline(0, 1, lty = 2, col = "red")
legend("topleft", lty = 1, col = c("green", "blue", "yellow", "black"), c("ASH", "GD-ASH", "qvalue", "BH"))
```
...
```{r zero average fsp, cache = TRUE, echo = FALSE}
...
lines(fsr.list, colMeans(matrix(unlist(fsp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fsr.list, colMeans(matrix(unlist(fsp.gdash), nrow = m, byrow = TRUE)), col = "blue")
abline(0, 1, lty = 2, col = "red")
...
```{r small average fdp, cache = TRUE, echo = FALSE}
plot(fdr.list, fdr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Discovery Rate", ylab = "Average False Discovery Proportion", main = "Calibration of pFDR")
lines(fdr.list, colMeans(matrix(unlist(fdp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fdr.list, colMeans(matrix(unlist(fdp.gdash), nrow = m, byrow = TRUE)), col = "blue")
...
```{r small average fsp, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Discovery Rate", ylab = "Average False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, colMeans(matrix(unlist(fsp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fsr.list, colMeans(matrix(unlist(fsp.gdash), nrow = m, byrow = TRUE)), col = "blue")
...
```{r medium average fdp, cache = TRUE, echo = FALSE}
plot(fdr.list, fdr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Discovery Rate", ylab = "Average False Discovery Proportion", main = "Calibration of pFDR")
lines(fdr.list, colMeans(matrix(unlist(fdp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fdr.list, colMeans(matrix(unlist(fdp.gdash), nrow = m, byrow = TRUE)), col = "blue")
...
```{r medium average fsp, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Discovery Rate", ylab = "Average False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, colMeans(matrix(unlist(fsp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fsr.list, colMeans(matrix(unlist(fsp.gdash), nrow = m, byrow = TRUE)), col = "blue")
...
```{r big average fdp, cache = TRUE, echo = FALSE}
plot(fdr.list, fdr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Discovery Rate", ylab = "Average False Discovery Proportion", main = "Calibration of pFDR")
lines(fdr.list, colMeans(matrix(unlist(fdp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fdr.list, colMeans(matrix(unlist(fdp.gdash), nrow = m, byrow = TRUE)), col = "blue")
...
```{r big average fsp, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Discovery Rate", ylab = "Average False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, colMeans(matrix(unlist(fsp.ash), nrow = m, byrow = TRUE)), col = "green")
lines(fsr.list, colMeans(matrix(unlist(fsp.gdash), nrow = m, byrow = TRUE)), col = "blue")
