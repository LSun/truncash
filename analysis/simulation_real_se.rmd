...
lines(fdr.list, fdp.ash[[17]], col = "green")
lines(fdr.list, fdp.gdash[[17]], col = "blue")
lines(fdr.list, fdp.qvalue[[17]], col = "yellow")
lines(fdr.list, fdp.BH[[17]])
abline(0, 1, lty = 2, col = "red")
...
```{r zero fsp gdash-ash, cache = TRUE, echo = FALSE, eval = FALSE}
K = (fsr.list <= 0.5)
fsp.ash.diff = fsp.gdash.diff = c()
for (i in 1 : m) {
  fsp.ash.diff[i] = mean(abs(fsp.ash[[i]][1 : K] - fsr.list[1 : K]))
  fsp.gdash.diff[i] = mean(abs(fsp.gdash[[i]][1 : K] - fsr.list[1 : K]))
}
boxplot(fsp.ash.diff, fsp.gdash.diff, 
        names = c("ASH", "GD-ASH"),
        ylab = expression("FSP - FSR")
)
plot(fsp.ash.diff, fsp.gdash.diff, xlim = range(fsp.ash.diff, fsp.gdash.diff), ylim = range(fsp.ash.diff, fsp.gdash.diff), xlab = "ASH", ylab = "GD-ASH")
abline(0, 1, lty = 2, col = "red")
```

```{r zero fsp plotting, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Sign Rate", ylab = "Empirical False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, fsp.ash[[17]], col = "green")
lines(fsr.list, fsp.gdash[[17]], col = "blue")
abline(0, 1, lty = 2, col = "red")
...
```{r small fsp plotting, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Sign Rate", ylab = "Empirical False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, fsp.ash[[17]], col = "green")
lines(fsr.list, fsp.gdash[[17]], col = "blue")
...
```{r medium fsp plotting, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Sign Rate", ylab = "Empirical False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, fsp.ash[[17]], col = "green")
lines(fsr.list, fsp.gdash[[17]], col = "blue")
...
```{r big fsp plotting, cache = TRUE, echo = FALSE}
plot(fsr.list, fsr.list, type = "n",
     xlim = c(0, 1), ylim = c(0, 1), xlab = "Nominal False Sign Rate", ylab = "Empirical False Sign Proportion", main = "Calibration of S values")
lines(fsr.list, fsp.ash[[17]], col = "green")
lines(fsr.list, fsp.gdash[[17]], col = "blue")
