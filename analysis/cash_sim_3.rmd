---
title: "Large-scale simulation for the cash paper, Part 3: Under-dispersion"
author: "Lei Sun"
date: 2017-11-10
...
## Conditioned on under-dispersed data sets only
...
sum(deflation.index)
z.mat = z.mat[deflation.index, ]
se.mat = se.mat[deflation.index, ]
```
...
plot(pFDR.nominal, pFDR.nominal, ylim = c(0, 2 * max(pFDR.nominal)), type = "n", xlab = "Nominal Positive False Discovery Rate", ylab = "Average Positive False Discovery Proportion", main = "Calibration of Positive FDR (Under-Dispersion)")
