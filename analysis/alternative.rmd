---
title: "Alternative vs Correlated Null"
author: "Lei Sun"
date: 2017-03-29
...
Scale weights $w_k^s = \sqrt{k!}w_k$, so that $\text{var}(w_k^s) = \alpha_k = 
\bar{\rho_{ij}^k}$.
...
K = c(7, 7, 7)
for (i in 1:3) {
  cat("Number of False Discoveries:", res[[i]]$bh.fd, "; pihat0 =", res[[i]]$pihat0.ash, "\n")
  cat("Scaled weights:\n")
