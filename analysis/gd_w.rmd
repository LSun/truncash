...
plot(ecdf(z), xlab = "", ylab = "", lwd = 2, main = expression("(a): CDF of Hist. (c)"), cex.main = 1.5)
...
plot(ecdf(z), xlab = "", ylab = "", main = expression("(b): Left Tail"), lwd = 2, xlim = c(-5, -2.75), ylim = c(0, 0.04), cex.main = 1.5)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01)), col = "blue", lwd = 2)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01), 0, 1.6), col = "green", lwd = 2)

plot(ecdf(z), xlab = "", ylab = "", main = expression("(c): Right tail"), lwd = 2, xlim = c(2.75, 5), ylim = c(0.96, 1), cex.main = 1.5)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01)), col = "blue", lwd = 2)
lines(seq(-6, 6, by = 0.01), pnorm(seq(-6, 6, by = 0.01), 0, 1.6), col = "green", lwd = 2)
...
# 7.5 * 3
setEPS()
postscript("../output/fig/cor_z_pval.eps", width = 7.5, height = 3.5)
...
set.seed(6)
plot(-log(pnorm(-abs(rnorm(1e4))) * 2), ylim = c(0, 20), ylab = "-log(p)", main = expression(paste("(d): Independent ", N(0, 1))), pch = 19, cex = 0.5, col = "blue", cex.main = 1.5, cex.lab = 1.5)
abline(h = -log(0.005), col = "red", lwd = 2)
abline(h = -log(pnorm(-sqrt(2 * log(1e4))) * 2), col = "yellow", lwd = 2)
abline(h = -log(0.05 / 1e4), col = "orange", lwd = 2)

plot(sample(-log(p)), ylim = c(0, 20), ylab = "-log(p)", main = expression("(e): Hist. (c)"), pch = 19, cex = 0.5, cex.main = 1.5, cex.lab = 1.5)
abline(h = -log(0.005), col = "red", lwd = 2)
abline(h = -log(pnorm(-sqrt(2 * log(1e4))) * 2), col = "yellow", lwd = 2)
abline(h = -log(0.05 / 1e4), col = "orange", lwd = 2)

plot(-log(pnorm(-abs(rnorm(1e4, 0, 1.6))) * 2), ylim = c(0, 20), ylab = "-log(p)", main = expression(paste("(f): Independent ", N(0, 1.6^2))), pch = 19, cex = 0.5, col = "green", cex.main = 1.5, cex.lab = 1.5)
abline(h = -log(0.005), col = "red", lwd = 2)
abline(h = -log(pnorm(-sqrt(2 * log(1e4))) * 2), col = "yellow", lwd = 2)
abline(h = -log(0.05 / 1e4), col = "orange", lwd = 2)
...
legend("bottomleft", inset = c(-2.01, -0.65), legend = c("0.005", "Bonferroni", "Universal Threshold"), lty = 1, lwd = 2, xpd = NA, col = c("red", "yellow", "orange"), ncol = 3, cex = 1.25)
